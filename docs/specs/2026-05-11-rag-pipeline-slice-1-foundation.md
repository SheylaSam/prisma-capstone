...
└── 0006_enable_pgvector_and_create_embeddings.py     (NEU)
...
`backend/alembic/versions/0006_enable_pgvector_and_create_embeddings.py`:
...
- [ ] Migration `0006_enable_pgvector_and_create_embeddings.py` laeuft up und down ohne Errors
